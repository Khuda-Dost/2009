...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/Khuda-Dost/approval/blob/main/kd.txt"])
	exit(" [*] FACEBOOK :  https://www.facebook.com/kd")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN🧞‍♀️ MESSENGER🔰🥰https://www.facebook.com/Kd")
	subprocess.check_output(["am", "start", "https://www.facebook.com/Kd"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/Khuda-Dost/approval/blob/main/kd.txt"])').text
			if basesplit in plr:
				key = basesplit
...
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB   : ROX007-R
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mWARNING  : DON'T TRAY TO BYPASS 
\033[1;90m══════════════════════════════════════════════════
    """)
		print("%s [%s•%s] %sTOOL NAME : %sROX007❌ PRO CLONER❌"%(G,R,G,B,G))
	...
	def email(self):
		x = 111
		xx = 999
		nam = input("%s [?] TYPE A NAME %s(EX: ROX007): "%(Y,G))
		nam = nam.replace(" ", "")
